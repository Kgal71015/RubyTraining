...
class LogParser
  ...
  def read_most_viewed_pages
    read_most_viewed(read_file_content)
  end

  def read_most_unique_visited_pages
    read_most_unique(read_file_content)
  end
  ...
  def read_most_viewed(file_content)
  ...
  def read_most_unique(file_content)
